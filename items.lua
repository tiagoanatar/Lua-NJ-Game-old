...
local temp_index = 0 -- usado nos items 3 e 4
local emission_rate = 1 -- usado no item 6(smoke)
...
item_use = "off" -- variavel global usada para fazer o painel desaparecer em caso de uso de item 
...
function items_reset()
  ...
  -- desativando variavel de uso de item
  item_use = "off"
...
function items_draw_use()
  ...
  if temp_index > 0 then
    ...
    if item_combat_active == "on" and item[temp_index].drop == "enemy" then
      love.graphics.setColor(1, 1, 1, 1) -- normalizador de cor
